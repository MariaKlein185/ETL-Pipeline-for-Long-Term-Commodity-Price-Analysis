...
Download the two csv datasets: Milkdata.csv and Egg.csv
upload data to the DS2002Project.ipynb and run
then you can clean data through Merging data into one dataset: Modifying dataset by removing columns and Data analysis with summary statistics
